...
class MyElement extends HTMLElement {
    ...
    userNameSignup: HTMLInputElement;
    emailField: HTMLInputElement;
    passSignUpField: HTMLInputElement;
    passSignUpFieldConfirm: HTMLInputElement;
    ...
    connectedCallback() {
        ...
        subscribe = shadow.querySelector("#subscribe");
    ...
    fireEvent( e: Event ) : boolean {  
        const shadow: ShadowRoot = this.shadowRoot;
        this.nameField = shadow.querySelector('#username');
        this.passField = shadow.querySelector('#password');
        this.chkbox = shadow.querySelector('#loginkeeping');
        this.userNameSignup = shadow.querySelector('#usernamesignup');
        this.emailField = shadow.querySelector('#emailsignup');
        this.passSignUpField = shadow.querySelector('#passwordsignup');
        this.passSignUpFieldConfirm = shadow.querySelector('#passwordsignup_confirm');
        ...
        this.dispatchEvent(new CustomEvent("register-event", {
            ...
            detail: { 
                ...
                rememberMe: this.chkbox.checked,
                email: this.emailField.value,
                newPassword: this.passSignUpField.value,
                newPasswordConfirmation: this.passSignUpFieldConfirm.value,
            }
        }));
